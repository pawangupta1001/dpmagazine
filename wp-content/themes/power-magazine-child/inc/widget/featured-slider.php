...
function power_magazine_action_featured_slider1() {
  ...
  remove_action('widgets_init', 'Power_magazine_Featured_Slider');
...
function power_magazine_action_featured_slider11() {



  register_widget( 'Power_magazine_Featured_Slider1' );



}

add_action( 'widgets_init', 'power_magazine_action_featured_slider11' );


class Power_magazine_Featured_Slider1 extends WP_Widget{
    ...
    function widget( $args, $instance ) {
        ...
        if ($the_query->have_posts()) : $count= 0; ?>
            ...
            <div class="row main-slider-wrap absolute-content" data-play="<?php echo esc_attr( $enable_autoplay );?>">
                ...
                <?php while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
                    ...
                    <article class="featured-post post hentry category-featured" >
                        ...
                        <?php if ( has_post_thumbnail() ){ ?>
                            ...
                            <figure class="custom-col-7 featured-post-image">
                    ...
                    <div class="custom-col-5 post-content" style="float: right">
