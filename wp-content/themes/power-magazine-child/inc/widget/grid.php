...
function power_magazine_action_grid1() {



  //register_widget( 'Power_magazine_Featured_Slider' );
  remove_action('widgets_init', 'Power_magazine_Grid');
...
function power_magazine_action_grid11() {



  register_widget( 'Power_magazine_Grid1' );



}

add_action( 'widgets_init', 'power_magazine_action_grid11' );
...
//}
//add_action( 'widgets_init', 'power_magazine_action_grid' );
class Power_magazine_Grid1 extends WP_Widget{
    ...
    function widget( $args, $instance ) {
        ...
        if ($the_query->have_posts()) : $count= 0; ?>
            <div class="business-wrap">
            	...
            	<?php if($count ==1 && ($category==18 || $category==4)){ ?>
                    <article class="featured-post post hentry category-featured left-80">
                <?php }elseif($category==18 || $category==4){ ?>
                    <article class="right-20 featured-post post hentry category-featured">
                <?php }else{ ?>
                    <article class="test featured-post post hentry category-featured">
                <?php } ?>
                    ...
                    <?php if($count ==2 && $category==15){ ?>
                        <article class="test featured-post post hentry category-featured">
                            <figure class="featured-post-image">
                                 <img class="article-image" src="<?php get_bloginfo('url'); ?>wp-content/uploads/2020/07/6392568418203905723.jpg">
                            </figure>

                    </article>
                    <?php } ?>
                    <?php if($count ==1 && $category==18){ ?>
                        <article class="test featured-post post hentry category-featured">
                            <figure class="featured-post-image">
                                 <img class="article-image" src="<?php get_bloginfo('url'); ?>wp-content/uploads/2020/07/cover-june.jpg">
                            </figure>

                    </article>
                    <?php } ?>
                    <?php if($count ==2 && $category==16){ ?>
                        <article class="test featured-post post hentry category-featured">
                            <figure class="featured-post-image">
                                 <img class="article-image" src="<?php get_bloginfo('url'); ?>wp-content/uploads/2020/07/5896349404192071633.jpg">
                            </figure>

                    </article>
                    <?php } ?>
                    <?php if($count ==1 && $category==4){ ?>
                        <article class="test featured-post post hentry category-featured">
                            <figure class="featured-post-image">
                                 <img class="article-image" src="<?php get_bloginfo('url'); ?>wp-content/uploads/2020/07/972942132536390351.png">
                            </figure>
                            <figure class="featured-post-image">
                                 <img class="article-image" src="<?php get_bloginfo('url'); ?>wp-content/uploads/2020/07/RHVIKZ6Y4FC2XKJZKHUFEV.jpg">
                            </figure>
